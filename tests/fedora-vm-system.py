...
guide_spec = importlib.util.spec_from_file_location('guide', Path(__file__).with_name('fedora-vm-keybindings.py'))
guide = importlib.util.module_from_spec(guide_spec)
guide_spec.loader.exec_module(guide)
v.check('interactive keybindings guide', lambda: guide.guide(v))
